...
<body>
    ...
    {{-- Toast Notifications --}}
    <div class="bs-toast toast toast-placement-ex m-2 fade bg-white" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="2000">
    ...
    @endif
    @if(session('warning'))
        <div id="flash-warning" style="display: none;">{{ session('warning') }}</div>
    @endif
    @if(session('info'))
        <div id="flash-info" style="display: none;">{{ session('info') }}</div>
    @endif

    {{-- Toast Notification Script --}}
    <script src="{{ asset('assets/js/flash-toasts.js') }}"></script>
